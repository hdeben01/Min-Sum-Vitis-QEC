...
set name compute_check_to_value_fmul_32ns_32ns_32_3_max_dsp_1
...
eval "cg_default_interface_gen_dc { \
    id 19 \
    name row_sign_1_reload \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_row_sign_1_reload \
    op interface \
    ports { row_sign_1_reload { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 21 \
    name minpos_2_reload \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_minpos_2_reload \
    op interface \
    ports { minpos_2_reload { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_min1_3_reload \
    op interface \
    ports { min1_3_reload { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_min2_3_reload \
    op interface \
    ports { min2_3_reload { I 32 vector } } \
} "
}
...
set InstName compute_check_to_value_flow_control_loop_pipe_sequential_init_U
set CompName compute_check_to_value_flow_control_loop_pipe_sequential_init
set name flow_control_loop_pipe_sequential_init
if {${::AESL::PGuard_autocg_gen} && ${::AESL::PGuard_autocg_ipmgen}} {
if {[info proc ::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control] == "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control"} {
eval "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control { \
    name ${name} \
    prefix compute_check_to_value_ \
}"
} else {
