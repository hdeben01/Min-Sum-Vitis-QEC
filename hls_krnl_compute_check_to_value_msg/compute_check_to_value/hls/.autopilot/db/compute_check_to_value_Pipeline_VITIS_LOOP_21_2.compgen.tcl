...
set name compute_check_to_value_fcmp_32ns_32ns_1_2_no_dsp_1
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_min2_3_out \
    op interface \
    ports { min2_3_out { O 32 vector } min2_3_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_min1_3_out \
    op interface \
    ports { min1_3_out { O 32 vector } min1_3_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_minpos_2_out \
    op interface \
    ports { minpos_2_out { O 32 vector } minpos_2_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_row_sign_1_out \
    op interface \
    ports { row_sign_1_out { O 32 vector } row_sign_1_out_ap_vld { O 1 bit } } \
} "
}
