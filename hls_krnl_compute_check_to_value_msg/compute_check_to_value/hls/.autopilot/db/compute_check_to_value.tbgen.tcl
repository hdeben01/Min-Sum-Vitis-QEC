set moduleName compute_check_to_value
set isTopModule 1
...
set cdfgNum 5
set C_modelName {compute_check_to_value}
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "L","offset": { "type": "dynamic","port_name": "L","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[ {"cElement": [{"cName": "syndrome","offset": { "type": "dynamic","port_name": "syndrome","bundle": "control"},"direction": "READONLY"},{"cName": "out_r","offset": { "type": "dynamic","port_name": "out_r","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "L", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "offset" : {"in":16}, "offset_end" : {"in":27}} , 
 	{ "Name" : "syndrome", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "offset" : {"in":28}, "offset_end" : {"in":39}} , 
...
set NewPortList {[ 
	{ "name": "s_axi_control_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "control", "role": "AWADDR" },"address":[{"name":"compute_check_to_value","role":"start","value":"0","valid_bit":"0"},{"name":"compute_check_to_value","role":"continue","value":"0","valid_bit":"4"},{"name":"compute_check_to_value","role":"auto_start","value":"0","valid_bit":"7"},{"name":"L","role":"data","value":"16"},{"name":"syndrome","role":"data","value":"28"},{"name":"out_r","role":"data","value":"40"},{"name":"size_checks","role":"data","value":"52"},{"name":"size_vnode","role":"data","value":"60"}] },
	...
	{ "name": "s_axi_control_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "control", "role": "ARADDR" },"address":[{"name":"compute_check_to_value","role":"start","value":"0","valid_bit":"0"},{"name":"compute_check_to_value","role":"done","value":"0","valid_bit":"1"},{"name":"compute_check_to_value","role":"idle","value":"0","valid_bit":"2"},{"name":"compute_check_to_value","role":"ready","value":"0","valid_bit":"3"},{"name":"compute_check_to_value","role":"auto_start","value":"0","valid_bit":"7"}] },
...
set ArgLastReadFirstWriteLatency {
	compute_check_to_value {
		...
		gmem0 {Type IO LastRead 79 FirstWrite 78}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "7581", "Max" : "7581"}
	, {"Name" : "Interval", "Min" : "7582", "Max" : "7582"}
]}
