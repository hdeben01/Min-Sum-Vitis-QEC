# 1 "../hls_krnl_compute_check_to_value_msg.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 376 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../hls_krnl_compute_check_to_value_msg.cpp" 2
# 1 "../compute_check_to_value_msg.h" 1
...
__attribute__((sdx_kernel("compute_check_to_value", 0))) void compute_check_to_value(float L[20][40], int* syndrome, float out[20][40], int size_checks,int size_vnode);
# 2 "../hls_krnl_compute_check_to_value_msg.cpp" 2
# 1 "/tools/Xilinx/2025.1/Vitis/tps/lnx64/gcc-8.3.0/lib/gcc/x86_64-pc-linux-gnu/8.3.0/../../../../include/c++/8.3.0/math.h" 1 3
# 36 "/tools/Xilinx/2025.1/Vitis/tps/lnx64/gcc-8.3.0/lib/gcc/x86_64-pc-linux-gnu/8.3.0/../../../../include/c++/8.3.0/math.h" 3
# 1 "/tools/Xilinx/2025.1/Vitis/tps/lnx64/gcc-8.3.0/lib/gcc/x86_64-pc-linux-gnu/8.3.0/../../../../include/c++/8.3.0/cmath" 1 3
# 40 "/tools/Xilinx/2025.1/Vitis/tps/lnx64/gcc-8.3.0/lib/gcc/x86_64-pc-linux-gnu/8.3.0/../../../../include/c++/8.3.0/cmath" 3
...
# 42 "/tools/Xilinx/2025.1/Vitis/tps/lnx64/gcc-8.3.0/lib/gcc/x86_64-pc-linux-gnu/8.3.0/../../../../include/c++/8.3.0/cmath" 2 3
...
# 43 "/tools/Xilinx/2025.1/Vitis/tps/lnx64/gcc-8.3.0/lib/gcc/x86_64-pc-linux-gnu/8.3.0/../../../../include/c++/8.3.0/cmath" 2 3
...
# 44 "/tools/Xilinx/2025.1/Vitis/tps/lnx64/gcc-8.3.0/lib/gcc/x86_64-pc-linux-gnu/8.3.0/../../../../include/c++/8.3.0/cmath" 2 3
...
# 46 "/tools/Xilinx/2025.1/Vitis/tps/lnx64/gcc-8.3.0/lib/gcc/x86_64-pc-linux-gnu/8.3.0/../../../../include/c++/8.3.0/cmath" 2 3
...
# 39 "/tools/Xilinx/2025.1/Vitis/tps/lnx64/gcc-8.3.0/lib/gcc/x86_64-pc-linux-gnu/8.3.0/../../../../include/c++/8.3.0/bits/std_abs.h" 2 3
...
# 48 "/tools/Xilinx/2025.1/Vitis/tps/lnx64/gcc-8.3.0/lib/gcc/x86_64-pc-linux-gnu/8.3.0/../../../../include/c++/8.3.0/cmath" 2 3
# 77 "/tools/Xilinx/2025.1/Vitis/tps/lnx64/gcc-8.3.0/lib/gcc/x86_64-pc-linux-gnu/8.3.0/../../../../include/c++/8.3.0/cmath" 3
extern "C++"
{
namespace std __attribute__ ((__visibility__ ("default")))
{
...
# 412 "/tools/Xilinx/2025.1/Vitis/tps/lnx64/gcc-8.3.0/lib/gcc/x86_64-pc-linux-gnu/8.3.0/../../../../include/c++/8.3.0/cmath" 3
  template<typename _Tp, typename _Up>
    inline constexpr
    typename __gnu_cxx::__promote_2<_Tp, _Up>::__type
    pow(_Tp __x, _Up __y)
...
# 536 "/tools/Xilinx/2025.1/Vitis/tps/lnx64/gcc-8.3.0/lib/gcc/x86_64-pc-linux-gnu/8.3.0/../../../../include/c++/8.3.0/cmath" 3
  constexpr int
...
# 1065 "/tools/Xilinx/2025.1/Vitis/tps/lnx64/gcc-8.3.0/lib/gcc/x86_64-pc-linux-gnu/8.3.0/../../../../include/c++/8.3.0/cmath" 3
  using ::double_t;
  using ::float_t;
...
# 1889 "/tools/Xilinx/2025.1/Vitis/tps/lnx64/gcc-8.3.0/lib/gcc/x86_64-pc-linux-gnu/8.3.0/../../../../include/c++/8.3.0/cmath" 3
}
...
# 37 "/tools/Xilinx/2025.1/Vitis/tps/lnx64/gcc-8.3.0/lib/gcc/x86_64-pc-linux-gnu/8.3.0/../../../../include/c++/8.3.0/math.h" 2 3
...
using std::tgamma;
using std::trunc;
# 3 "../hls_krnl_compute_check_to_value_msg.cpp" 2
# 1 "/tools/Xilinx/2025.1/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/float.h" 1 3
# 4 "../hls_krnl_compute_check_to_value_msg.cpp" 2



__attribute__((sdx_kernel("compute_check_to_value", 0))) void compute_check_to_value(float L[20][40], int* syndrome, float out[20][40], int size_checks,int size_vnode){
#line 1 "directive"
#pragma HLSDIRECTIVE TOP name=compute_check_to_value
# 7 "../hls_krnl_compute_check_to_value_msg.cpp"


#pragma HLS INTERFACE mode=m_axi depth=size_vnode port=syndrome bundle=gmem0
#pragma HLS INTERFACE mode=m_axi depth=20*40 port=L bundle=gmem1
#pragma HLS INTERFACE mode=m_axi depth=20*40 port=out bundle=gmem0
 VITIS_LOOP_12_1: for(int i = 0; i < 20; i++){
#pragma HLS LOOP_TRIPCOUNT min = 20 max = 20
 if(i == size_checks) break;

        float min1 = 3.40282347e+38F,min2 = 3.40282347e+38F;
        int minpos = -1;
        int row_sign = 1;
        float product = 1.0;

        VITIS_LOOP_21_2: for(int j = 0; j < 40; j++){
#pragma HLS LOOP_TRIPCOUNT min = 40 max = 40
 float val_i_j = L[i][j];
        ...
        VITIS_LOOP_36_3: for(int j = 0; j < 40; j++){
#pragma HLS LOOP_TRIPCOUNT min = 40 max = 40
 if(j == size_vnode) break;
            float val_i_j = L[i][j];
