set moduleName compute_row_operations_Pipeline_VITIS_LOOP_87_9_VITIS_LOOP_89_10
set isTopModule 0
...
set cdfgNum 8
set C_modelName {compute_row_operations_Pipeline_VITIS_LOOP_87_9_VITIS_LOOP_89_10}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict L_cache { MEM_WIDTH 32 MEM_SIZE 12 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict L_cache_1 { MEM_WIDTH 32 MEM_SIZE 12 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict L_cache_2 { MEM_WIDTH 32 MEM_SIZE 12 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict L_cache_3 { MEM_WIDTH 32 MEM_SIZE 12 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict L_cache_4 { MEM_WIDTH 32 MEM_SIZE 12 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict L_cache_5 { MEM_WIDTH 32 MEM_SIZE 12 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict L_cache_6 { MEM_WIDTH 32 MEM_SIZE 12 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict L_cache_7 { MEM_WIDTH 32 MEM_SIZE 12 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict L_cache_8 { MEM_WIDTH 32 MEM_SIZE 12 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict L_cache_9 { MEM_WIDTH 32 MEM_SIZE 12 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ gmem0 int 64 regular {axi_master 1}  }
	{ sext_ln15 int 61 regular  }
	{ L_cache float 32 regular {array 3 { 1 3 } 1 1 }  }
	{ L_cache_1 float 32 regular {array 3 { 1 3 } 1 1 }  }
	{ L_cache_2 float 32 regular {array 3 { 1 3 } 1 1 }  }
	{ L_cache_3 float 32 regular {array 3 { 1 3 } 1 1 }  }
	{ L_cache_4 float 32 regular {array 3 { 1 3 } 1 1 }  }
	{ L_cache_5 float 32 regular {array 3 { 1 3 } 1 1 }  }
	{ L_cache_6 float 32 regular {array 3 { 1 3 } 1 1 }  }
	{ L_cache_7 float 32 regular {array 3 { 1 3 } 1 1 }  }
	{ L_cache_8 float 32 regular {array 3 { 1 3 } 1 1 }  }
	{ L_cache_9 float 32 regular {array 3 { 1 3 } 1 1 }  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 64, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "L","offset": { "type": "dynamic","port_name": "L","bundle": "control"},"direction": "READWRITE"}]}]} , 
 	{ "Name" : "sext_ln15", "interface" : "wire", "bitwidth" : 61, "direction" : "READONLY"} , 
 	{ "Name" : "L_cache", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "L_cache_1", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "L_cache_2", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "L_cache_3", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "L_cache_4", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "L_cache_5", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "L_cache_6", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "L_cache_7", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "L_cache_8", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "L_cache_9", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} ]}
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "L_cache_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "L_cache", "role": "q0" }} , 
 	...
 	{ "name": "L_cache_1_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "L_cache_1", "role": "q0" }} , 
 	...
 	{ "name": "L_cache_2_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "L_cache_2", "role": "q0" }} , 
 	...
 	{ "name": "L_cache_3_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "L_cache_3", "role": "q0" }} , 
 	...
 	{ "name": "L_cache_4_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "L_cache_4", "role": "q0" }} , 
 	...
 	{ "name": "L_cache_5_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "L_cache_5", "role": "q0" }} , 
...
set ArgLastReadFirstWriteLatency {
	compute_row_operations_Pipeline_VITIS_LOOP_87_9_VITIS_LOOP_89_10 {
		...
		L_cache {Type I LastRead 0 FirstWrite -1}
		L_cache_1 {Type I LastRead 0 FirstWrite -1}
		L_cache_2 {Type I LastRead 0 FirstWrite -1}
		L_cache_3 {Type I LastRead 0 FirstWrite -1}
		L_cache_4 {Type I LastRead 0 FirstWrite -1}
		L_cache_5 {Type I LastRead 0 FirstWrite -1}
		L_cache_6 {Type I LastRead 0 FirstWrite -1}
		L_cache_7 {Type I LastRead 0 FirstWrite -1}
		L_cache_8 {Type I LastRead 0 FirstWrite -1}
		L_cache_9 {Type I LastRead 0 FirstWrite -1}}}
...
set Spec2ImplPortList { 
	...
	L_cache { ap_memory {  { L_cache_address0 mem_address 1 2 }  { L_cache_ce0 mem_ce 1 1 }  { L_cache_q0 mem_dout 0 32 } } }
	L_cache_1 { ap_memory {  { L_cache_1_address0 mem_address 1 2 }  { L_cache_1_ce0 mem_ce 1 1 }  { L_cache_1_q0 mem_dout 0 32 } } }
	L_cache_2 { ap_memory {  { L_cache_2_address0 mem_address 1 2 }  { L_cache_2_ce0 mem_ce 1 1 }  { L_cache_2_q0 mem_dout 0 32 } } }
	L_cache_3 { ap_memory {  { L_cache_3_address0 mem_address 1 2 }  { L_cache_3_ce0 mem_ce 1 1 }  { L_cache_3_q0 mem_dout 0 32 } } }
	L_cache_4 { ap_memory {  { L_cache_4_address0 mem_address 1 2 }  { L_cache_4_ce0 mem_ce 1 1 }  { L_cache_4_q0 mem_dout 0 32 } } }
	L_cache_5 { ap_memory {  { L_cache_5_address0 mem_address 1 2 }  { L_cache_5_ce0 mem_ce 1 1 }  { L_cache_5_q0 mem_dout 0 32 } } }
	L_cache_6 { ap_memory {  { L_cache_6_address0 mem_address 1 2 }  { L_cache_6_ce0 mem_ce 1 1 }  { L_cache_6_q0 mem_dout 0 32 } } }
	L_cache_7 { ap_memory {  { L_cache_7_address0 mem_address 1 2 }  { L_cache_7_ce0 mem_ce 1 1 }  { L_cache_7_q0 mem_dout 0 32 } } }
	L_cache_8 { ap_memory {  { L_cache_8_address0 mem_address 1 2 }  { L_cache_8_ce0 mem_ce 1 1 }  { L_cache_8_q0 mem_dout 0 32 } } }
	L_cache_9 { ap_memory {  { L_cache_9_address0 mem_address 1 2 }  { L_cache_9_ce0 mem_ce 1 1 }  { L_cache_9_q0 mem_dout 0 32 } } }
}
