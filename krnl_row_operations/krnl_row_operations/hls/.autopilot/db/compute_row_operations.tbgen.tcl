set moduleName compute_row_operations
set isTopModule 1
...
set cdfgNum 8
set C_modelName {compute_row_operations}
...
set C_modelArgList {
	...
	{ L int 64 regular {axi_slave 0}  }
	{ non_zero int 64 regular {axi_slave 0}  }
	{ syndrome int 64 regular {axi_slave 0}  }
	{ size_checks int 32 regular {axi_slave 0}  }
	{ size_vnode int 32 regular {axi_slave 0}  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 64, "direction" : "READWRITE", "bitSlice":[ {"cElement": [{"cName": "L","offset": { "type": "dynamic","port_name": "L","bundle": "control"},"direction": "READWRITE"}]}]} , 
 	...
 	{ "Name" : "gmem2", "interface" : "axi_master", "bitwidth" : 8, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "syndrome","offset": { "type": "dynamic","port_name": "syndrome","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "L", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "offset" : {"in":16}, "offset_end" : {"in":27}} , 
 	{ "Name" : "non_zero", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "offset" : {"in":28}, "offset_end" : {"in":39}} , 
 	{ "Name" : "syndrome", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "offset" : {"in":40}, "offset_end" : {"in":51}} , 
 	{ "Name" : "size_checks", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "offset" : {"in":52}, "offset_end" : {"in":59}} , 
 	{ "Name" : "size_vnode", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "offset" : {"in":60}, "offset_end" : {"in":67}} ]}
...
set NewPortList {[ 
	{ "name": "s_axi_control_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "control", "role": "AWADDR" },"address":[{"name":"compute_row_operations","role":"start","value":"0","valid_bit":"0"},{"name":"compute_row_operations","role":"continue","value":"0","valid_bit":"4"},{"name":"compute_row_operations","role":"auto_start","value":"0","valid_bit":"7"},{"name":"L","role":"data","value":"16"},{"name":"non_zero","role":"data","value":"28"},{"name":"syndrome","role":"data","value":"40"},{"name":"size_checks","role":"data","value":"52"},{"name":"size_vnode","role":"data","value":"60"}] },
	...
	{ "name": "s_axi_control_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "control", "role": "ARADDR" },"address":[{"name":"compute_row_operations","role":"start","value":"0","valid_bit":"0"},{"name":"compute_row_operations","role":"done","value":"0","valid_bit":"1"},{"name":"compute_row_operations","role":"idle","value":"0","valid_bit":"2"},{"name":"compute_row_operations","role":"ready","value":"0","valid_bit":"3"},{"name":"compute_row_operations","role":"auto_start","value":"0","valid_bit":"7"}] },
...
set ArgLastReadFirstWriteLatency {
	compute_row_operations {
		gmem0 {Type IO LastRead 78 FirstWrite -1}
		gmem1 {Type I LastRead 1 FirstWrite -1}
		gmem2 {Type I LastRead 1 FirstWrite -1}
		L {Type I LastRead 0 FirstWrite -1}
		non_zero {Type I LastRead 0 FirstWrite -1}
		syndrome {Type I LastRead 0 FirstWrite -1}
		size_checks {Type I LastRead 74 FirstWrite -1}
		size_vnode {Type I LastRead 74 FirstWrite -1}}
	...
	compute_row_operations_Pipeline_VITIS_LOOP_31_5 {
		gmem2 {Type I LastRead 1 FirstWrite -1}
		syndrome {Type I LastRead 0 FirstWrite -1}
		syndrome_cache_2_out {Type O LastRead -1 FirstWrite 0}
		syndrome_cache_1_out {Type O LastRead -1 FirstWrite 0}
		syndrome_cache_out {Type O LastRead -1 FirstWrite 0}}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "214", "Max" : "245"}
	, {"Name" : "Interval", "Min" : "215", "Max" : "246"}
]}
