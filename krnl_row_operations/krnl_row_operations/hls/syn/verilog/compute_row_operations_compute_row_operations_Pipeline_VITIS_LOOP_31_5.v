...
module compute_row_operations_compute_row_operations_Pipeline_VITIS_LOOP_31_5 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
        ...
        m_axi_gmem2_0_BUSER,
        syndrome,
        syndrome_cache_2_out,
        syndrome_cache_2_out_ap_vld,
        syndrome_cache_1_out,
        syndrome_cache_1_out_ap_vld,
        syndrome_cache_out,
        syndrome_cache_out_ap_vld
);
...
input  [63:0] syndrome;
output  [0:0] syndrome_cache_2_out;
output   syndrome_cache_2_out_ap_vld;
output  [0:0] syndrome_cache_1_out;
output   syndrome_cache_1_out_ap_vld;
output  [0:0] syndrome_cache_out;
output   syndrome_cache_out_ap_vld;

reg ap_idle;
reg m_axi_gmem2_0_RREADY;
reg syndrome_cache_2_out_ap_vld;
reg syndrome_cache_1_out_ap_vld;
reg syndrome_cache_out_ap_vld;
...
reg   [1:0] i_fu_54;
wire   [1:0] add_ln31_fu_116_p2;
wire    ap_loop_init;
reg   [1:0] ap_sig_allocacmp_i_2;
wire    ap_block_pp0_stage0;
reg   [0:0] syndrome_cache_fu_58;
wire   [0:0] syndrome_cache_3_fu_141_p1;
reg   [0:0] syndrome_cache_1_fu_62;
reg   [0:0] syndrome_cache_2_fu_66;
...
#0 i_fu_54 = 2'd0;
#0 syndrome_cache_fu_58 = 1'd0;
#0 syndrome_cache_1_fu_62 = 1'd0;
#0 syndrome_cache_2_fu_66 = 1'd0;
#0 ap_done_reg = 1'b0;
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln31_fu_110_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001_grp1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (i_2_reg_197 == 2'd1))) begin
        syndrome_cache_1_fu_62 <= syndrome_cache_3_fu_141_p1;
    end
end

always @ (posedge ap_clk) begin
    if ((~(i_2_reg_197 == 2'd1) & ~(i_2_reg_197 == 2'd0) & (1'b0 == ap_block_pp0_stage0_11001_grp1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        syndrome_cache_2_fu_66 <= syndrome_cache_3_fu_141_p1;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001_grp1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (i_2_reg_197 == 2'd0))) begin
        syndrome_cache_fu_58 <= syndrome_cache_3_fu_141_p1;
    end
end

always @ (*) begin
    if (((icmp_ln31_fu_110_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((ap_loop_exit_ready == 1'b1) & (icmp_ln31_fu_110_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001_grp1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        syndrome_cache_1_out_ap_vld = 1'b1;
    end else begin
        syndrome_cache_1_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((ap_loop_exit_ready == 1'b1) & (icmp_ln31_fu_110_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001_grp1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        syndrome_cache_2_out_ap_vld = 1'b1;
    end else begin
        syndrome_cache_2_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((ap_loop_exit_ready == 1'b1) & (icmp_ln31_fu_110_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001_grp1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        syndrome_cache_out_ap_vld = 1'b1;
    end else begin
        syndrome_cache_out_ap_vld = 1'b0;
    end
end
...
assign add_ln31_fu_116_p2 = (ap_sig_allocacmp_i_2 + 2'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_01001_grp1 = ((m_axi_gmem2_0_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end
...
assign icmp_ln31_fu_110_p2 = ((ap_sig_allocacmp_i_2 == 2'd3) ? 1'b1 : 1'b0);
...
assign syndrome_cache_1_out = syndrome_cache_1_fu_62;

assign syndrome_cache_2_out = syndrome_cache_2_fu_66;

assign syndrome_cache_3_fu_141_p1 = m_axi_gmem2_0_RDATA[0:0];

assign syndrome_cache_out = syndrome_cache_fu_58;

endmodule //compute_row_operations_compute_row_operations_Pipeline_VITIS_LOOP_31_5
