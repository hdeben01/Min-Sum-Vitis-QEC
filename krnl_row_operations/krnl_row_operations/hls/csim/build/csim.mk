...
HLS_SOURCES = ../../../../../compute_row_operations_tb.cpp ../../../../../compute_row_operations.cpp
...
$(ObjDir)/compute_row_operations_tb.o: ../../../../../compute_row_operations_tb.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../compute_row_operations_tb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/compute_row_operations_tb.d

$(ObjDir)/compute_row_operations.o: ../../../../../compute_row_operations.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../compute_row_operations.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/compute_row_operations.d
