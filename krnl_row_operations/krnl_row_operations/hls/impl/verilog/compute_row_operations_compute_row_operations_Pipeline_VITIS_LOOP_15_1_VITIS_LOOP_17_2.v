...
module compute_row_operations_compute_row_operations_Pipeline_VITIS_LOOP_15_1_VITIS_LOOP_17_2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    ap_idle_pp0;
reg   [0:0] icmp_ln15_reg_484;
reg   [0:0] trunc_ln17_reg_498;
reg    ap_predicate_op33_read_state2;
reg    ap_block_state2_pp0_stage0_iter1;
reg    ap_block_pp0_stage0_subdone;
wire   [0:0] icmp_ln15_fu_291_p2;
...
reg   [0:0] icmp_ln15_reg_484_pp0_iter1_reg;
wire   [0:0] icmp_ln17_fu_306_p2;
reg   [0:0] icmp_ln17_reg_488;
reg   [0:0] icmp_ln17_reg_488_pp0_iter1_reg;
wire   [3:0] select_ln15_fu_312_p3;
reg   [3:0] select_ln15_reg_494;
reg   [3:0] select_ln15_reg_494_pp0_iter1_reg;
wire   [0:0] trunc_ln17_fu_320_p1;
reg   [0:0] trunc_ln17_reg_498_pp0_iter1_reg;
reg   [63:0] gmem0_addr_read_reg_502;
reg   [63:0] ap_phi_mux_empty_phi_fu_258_p4;
wire   [63:0] ap_phi_reg_pp0_iter2_empty_reg_255;
wire   [63:0] zext_ln17_fu_408_p1;
wire   [63:0] zext_ln15_fu_394_p1;
reg   [31:0] shiftreg8_fu_98;
wire    ap_loop_init;
reg   [3:0] j_fu_102;
wire   [3:0] add_ln17_fu_346_p2;
reg   [3:0] ap_sig_allocacmp_j_load;
reg   [1:0] i_fu_106;
wire   [1:0] select_ln15_2_fu_387_p3;
reg   [4:0] indvar_flatten_fu_110;
wire   [4:0] add_ln15_fu_297_p2;
reg   [4:0] ap_sig_allocacmp_indvar_flatten_load;
reg    L_cache_8_we0_local;
wire   [31:0] bitcast_ln18_fu_417_p1;
...
wire   [1:0] add_ln15_1_fu_381_p2;
wire   [31:0] select_ln15_1_fu_374_p3;
wire   [31:0] trunc_ln18_fu_413_p1;
reg    ap_done_reg;
...
#0 shiftreg8_fu_98 = 32'd0;
#0 j_fu_102 = 4'd0;
#0 i_fu_106 = 2'd0;
#0 indvar_flatten_fu_110 = 5'd0;
#0 ap_done_reg = 1'b0;
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln15_fu_291_p2 == 1'd0))) begin
            indvar_flatten_fu_110 <= add_ln15_fu_297_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten_fu_110 <= 5'd0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            shiftreg8_fu_98 <= 32'd0;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            shiftreg8_fu_98 <= {{ap_phi_mux_empty_phi_fu_258_p4[63:32]}};
        end
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (select_ln15_reg_494_pp0_iter1_reg == 4'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (select_ln15_reg_494_pp0_iter1_reg == 4'd2))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (select_ln15_reg_494_pp0_iter1_reg == 4'd3))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (select_ln15_reg_494_pp0_iter1_reg == 4'd4))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (select_ln15_reg_494_pp0_iter1_reg == 4'd5))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (select_ln15_reg_494_pp0_iter1_reg == 4'd6))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (select_ln15_reg_494_pp0_iter1_reg == 4'd7))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (select_ln15_reg_494_pp0_iter1_reg == 4'd8))) begin
...
always @ (*) begin
    if ((~(select_ln15_reg_494_pp0_iter1_reg == 4'd0) & ~(select_ln15_reg_494_pp0_iter1_reg == 4'd1) & ~(select_ln15_reg_494_pp0_iter1_reg == 4'd2) & ~(select_ln15_reg_494_pp0_iter1_reg == 4'd3) & ~(select_ln15_reg_494_pp0_iter1_reg == 4'd4) & ~(select_ln15_reg_494_pp0_iter1_reg == 4'd5) & ~(select_ln15_reg_494_pp0_iter1_reg == 4'd6) & ~(select_ln15_reg_494_pp0_iter1_reg == 4'd7) & ~(select_ln15_reg_494_pp0_iter1_reg == 4'd8) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (select_ln15_reg_494_pp0_iter1_reg == 4'd0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln15_fu_291_p2 == 1'd1))) begin
...
always @ (*) begin
    if ((icmp_ln15_reg_484_pp0_iter1_reg == 1'd0)) begin
        if ((trunc_ln17_reg_498_pp0_iter1_reg == 1'd1)) begin
            ap_phi_mux_empty_phi_fu_258_p4 = zext_ln17_fu_408_p1;
        end else if ((trunc_ln17_reg_498_pp0_iter1_reg == 1'd0)) begin
...
assign L_cache_1_address0 = zext_ln15_fu_394_p1;

assign L_cache_1_ce0 = L_cache_1_ce0_local;

assign L_cache_1_d0 = bitcast_ln18_fu_417_p1;

assign L_cache_1_we0 = L_cache_1_we0_local;

assign L_cache_2_address0 = zext_ln15_fu_394_p1;

assign L_cache_2_ce0 = L_cache_2_ce0_local;

assign L_cache_2_d0 = bitcast_ln18_fu_417_p1;

assign L_cache_2_we0 = L_cache_2_we0_local;

assign L_cache_3_address0 = zext_ln15_fu_394_p1;

assign L_cache_3_ce0 = L_cache_3_ce0_local;

assign L_cache_3_d0 = bitcast_ln18_fu_417_p1;

assign L_cache_3_we0 = L_cache_3_we0_local;

assign L_cache_4_address0 = zext_ln15_fu_394_p1;

assign L_cache_4_ce0 = L_cache_4_ce0_local;

assign L_cache_4_d0 = bitcast_ln18_fu_417_p1;

assign L_cache_4_we0 = L_cache_4_we0_local;

assign L_cache_5_address0 = zext_ln15_fu_394_p1;

assign L_cache_5_ce0 = L_cache_5_ce0_local;

assign L_cache_5_d0 = bitcast_ln18_fu_417_p1;

assign L_cache_5_we0 = L_cache_5_we0_local;

assign L_cache_6_address0 = zext_ln15_fu_394_p1;

assign L_cache_6_ce0 = L_cache_6_ce0_local;

assign L_cache_6_d0 = bitcast_ln18_fu_417_p1;

assign L_cache_6_we0 = L_cache_6_we0_local;

assign L_cache_7_address0 = zext_ln15_fu_394_p1;

assign L_cache_7_ce0 = L_cache_7_ce0_local;

assign L_cache_7_d0 = bitcast_ln18_fu_417_p1;

assign L_cache_7_we0 = L_cache_7_we0_local;

assign L_cache_8_address0 = zext_ln15_fu_394_p1;

assign L_cache_8_ce0 = L_cache_8_ce0_local;

assign L_cache_8_d0 = bitcast_ln18_fu_417_p1;

assign L_cache_8_we0 = L_cache_8_we0_local;

assign L_cache_9_address0 = zext_ln15_fu_394_p1;

assign L_cache_9_ce0 = L_cache_9_ce0_local;

assign L_cache_9_d0 = bitcast_ln18_fu_417_p1;

assign L_cache_9_we0 = L_cache_9_we0_local;

assign L_cache_address0 = zext_ln15_fu_394_p1;

assign L_cache_ce0 = L_cache_ce0_local;

assign L_cache_d0 = bitcast_ln18_fu_417_p1;

assign L_cache_we0 = L_cache_we0_local;

assign add_ln15_1_fu_381_p2 = (i_fu_106 + 2'd1);

assign add_ln15_fu_297_p2 = (ap_sig_allocacmp_indvar_flatten_load + 5'd1);

assign add_ln17_fu_346_p2 = (select_ln15_fu_312_p3 + 4'd1);
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((ap_predicate_op33_read_state2 == 1'b1) & (m_axi_gmem0_0_RVALID == 1'b0));
end
...
assign ap_phi_reg_pp0_iter2_empty_reg_255 = 'bx;

always @ (*) begin
    ap_predicate_op33_read_state2 = ((trunc_ln17_reg_498 == 1'd0) & (icmp_ln15_reg_484 == 1'd0));
end

assign ap_ready = ap_ready_sig;

assign bitcast_ln18_fu_417_p1 = trunc_ln18_fu_413_p1;

assign icmp_ln15_fu_291_p2 = ((ap_sig_allocacmp_indvar_flatten_load == 5'd30) ? 1'b1 : 1'b0);

assign icmp_ln17_fu_306_p2 = ((ap_sig_allocacmp_j_load == 4'd10) ? 1'b1 : 1'b0);
...
assign select_ln15_1_fu_374_p3 = ((icmp_ln17_reg_488_pp0_iter1_reg[0:0] == 1'b1) ? 32'd0 : shiftreg8_fu_98);

assign select_ln15_2_fu_387_p3 = ((icmp_ln17_reg_488_pp0_iter1_reg[0:0] == 1'b1) ? add_ln15_1_fu_381_p2 : i_fu_106);

assign select_ln15_fu_312_p3 = ((icmp_ln17_fu_306_p2[0:0] == 1'b1) ? 4'd0 : ap_sig_allocacmp_j_load);

assign trunc_ln17_fu_320_p1 = select_ln15_fu_312_p3[0:0];

assign trunc_ln18_fu_413_p1 = ap_phi_mux_empty_phi_fu_258_p4[31:0];

assign zext_ln15_fu_394_p1 = select_ln15_2_fu_387_p3;

assign zext_ln17_fu_408_p1 = select_ln15_1_fu_374_p3;

endmodule //compute_row_operations_compute_row_operations_Pipeline_VITIS_LOOP_15_1_VITIS_LOOP_17_2
